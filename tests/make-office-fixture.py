"""Create an actual minimal Word fixture, with synthetic text only."""
import sys,zipfile
with zipfile.ZipFile(sys.argv[1],'w') as z:
 ...
 z.writestr('word/document.xml','<w:document xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main"><w:body><w:p><w:r><w:t>Elena Rossi. DOB: 14/03/2010. Email: elena@example.org</w:t></w:r></w:p></w:body></w:document>')
print('Synthetic Word fixture created')
